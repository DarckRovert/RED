    ...
    pub fn query(&self, req: CopilotQueryRequest) -> CopilotResponse {
            ...
            || prompt_lower.contains("inundacion")
        {
            (
                ...
                2. Ubícate en zonas de seguridad marcadas o junto a estructuras portantes.\n\
            ...
            || prompt_lower.contains("lora")
        {
            ...
            (
                format!(
                    "🤖 Copiloto IA RED (Modo Nano Local Off-Grid):\n\nRecibido: \"{}\"\n\n\
                    Instrucción guardada. Estoy optimizado para asistencia táctica, primeros auxilios, \
                    protocolos de sismo/apagón y guiado de supervivencia en redes malla sin internet.",
                    req.prompt
                ),
