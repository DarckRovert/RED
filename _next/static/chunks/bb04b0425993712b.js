(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,26520,e=>{"use strict";var t=e.i(14582);class a{static getClientSDKScript(e){return`
(function() {
...
window.addEventListener('DOMContentLoaded', init);`}},o="red_installed_miniapps_v1";class n{static instance=null;apps=new Map;constructor(){this.loadFromStorage(),this.ensureBuiltinApps()}static getInstance(){return n.instance||(n.instance=new n),n.instance}loadFromStorage(){try{let e=localStorage.getItem(o);e&&JSON.parse(e).forEach(e=>this.apps.set(e.manifest.id,e))}catch(e){console.error("[RedAppRegistry] Error loading apps from storage:",e)}}saveToStorage(){try{let e=Array.from(this.apps.values());localStorage.setItem(o,JSON.stringify(e))}catch(e){console.error("[RedAppRegistry] Error saving apps to storage:",e)}}ensureBuiltinApps(){[a,i,r].forEach(e=>{let t=this.apps.get(e.manifest.id);t?(t.manifest=e.manifest,t.bundle=e,t.isBuiltin=!0):this.apps.set(e.manifest.id,{manifest:e.manifest,bundle:e,installedAt:Date.now(),lastOpenedAt:Date.now(),grantedPermissions:e.manifest.permissions,isBuiltin:!0})}),this.saveToStorage()}getAllApps(){return Array.from(this.apps.values()).sort((e,t)=>t.lastOpenedAt-e.lastOpenedAt)}getApp(e){return this.apps.get(e)}installApp(e,t){let a={manifest:e.manifest,bundle:e,installedAt:Date.now(),lastOpenedAt:Date.now(),grantedPermissions:t||e.manifest.permissions,isBuiltin:!1};return this.apps.set(e.manifest.id,a),this.saveToStorage(),a}uninstallApp(e){let t=this.apps.get(e);if(t?.isBuiltin)return console.warn("No se pueden desinstalar aplicaciones nativas del sistema."),!1;let a=this.apps.delete(e);return a&&this.saveToStorage(),a}updatePermissions(e,t){let a=this.apps.get(e);a&&(a.grantedPermissions=t,this.saveToStorage())}touchApp(e){let t=this.apps.get(e);t&&(t.lastOpenedAt=Date.now(),this.saveToStorage())}exportAppPackage(e){let a=this.apps.get(e);if(!a)return null;let i=JSON.stringify({format:"RED_APP_PACKAGE_V1",exportedAt:Date.now(),bundle:a.bundle,manifest:a.manifest}),r="u">typeof btoa?btoa(unescape(encodeURIComponent(i))):t.Buffer.from(i).toString("base64");return`RED_APP_V1:${r}`}importAppPackage(e){try{let a=e.trim();a.startsWith("RED_APP_V1:")&&(a=a.substring(11));let i="u">typeof atob?decodeURIComponent(escape(atob(a))):t.Buffer.from(a,"base64").toString("utf8"),r=JSON.parse(i);if(!r.bundle||!r.bundle.manifest||!r.bundle.manifest.id||!r.bundle.html)return{bundle:null,isValid:!1,error:"Estructura de paquete inválida o manifiesto corrupto."};let o=r.bundle.manifest;if(!o.name||!o.version)return{bundle:null,isValid:!1,error:"El manifiesto no especifica nombre o versión."};if(!/^[a-zA-Z0-9_.-]{3,64}$/.test(o.id))return{bundle:null,isValid:!1,error:"El identificador de la aplicación debe ser alfanumérico (3-64 caracteres)."};if(!/^\d+\.\d+\.\d+/.test(o.version))return{bundle:null,isValid:!1,error:"La versión de la aplicación debe seguir el formato SemVer (ej: 1.0.0)."};return{bundle:r.bundle,isValid:!0}}catch(e){return{bundle:null,isValid:!1,error:e.message||"Error al decodificar paquete de aplicación."}}}}let s=n.getInstance();e.s(["redAppRegistry",0,s],19439)},91596,77319,e=>{"use strict";var t=e.i(85067),a=e.i(69104),i=e.i(55211),r=e.i(60352),o=e.i(8901),n=e.i(13045),s=e.i(83036),d=e.i(28719);class l{iframeWindow=null;manifest;context;meshSubscriptions=new Map;storagePrefix;unsubscribeMeshRouter=null;constructor(e,t,a){this.manifest=e,this.context=t,this.iframeWindow=a||null,this.storagePrefix=`red_app_storage_${e.id}_`}setIframeWindow(e){this.iframeWindow=e}updateGrantedPermissions(e){this.context.grantedPermissions=e}setupMeshRouterListener(){this.unsubscribeMeshRouter||(this.unsubscribeMeshRouter=a.meshRouter.onLocalDelivery(e=>{try{if(!e||!e.payload)return;let t=new TextDecoder().decode(e.payload);if(!t.startsWith("{"))return;let a=JSON.parse(t);if(a.appId===this.manifest.id)if("APP_DATA"===a.type){let t=a.topic||"default";(this.meshSubscriptions.has(t)||this.meshSubscriptions.has("*"))&&this.sendEvent("mesh.message",{topic:t,from:e.sender||"unknown",payload:a.payload,timestamp:a.timestamp||e.timestamp||Date.now()})}else"APP_DATA_DIRECT"===a.type&&this.sendEvent("mesh.directMessage",{from:e.sender||"unknown",payload:a.payload,timestamp:a.timestamp||e.timestamp||Date.now()})}catch{}}))}async handleMessage(e){let t=e.data;if(t&&"RED_SDK"===t.channel&&"RED_SDK_REQUEST"===t.type){if(t.appId!==this.manifest.id)return void this.sendResponse(t.requestId,!1,void 0,"App ID mismatch");try{let e=await this.dispatchMethod(t.method,t.params);this.sendResponse(t.requestId,!0,e)}catch(e){console.error(`[RedSDKBridge] Error executing ${t.method} for ${this.manifest.id}:`,e),this.sendResponse(t.requestId,!1,void 0,e.message||"Internal error")}}}async dispatchMethod(e,l){switch(e){case"identity.getProfile":return this.requirePermission("identity"),{did:this.context.userDid,nickname:this.context.nickname,publicKey:this.context.publicKey,appId:this.manifest.id};case"identity.signData":{this.requirePermission("identity");let e=l?.data||"",t=Date.now(),a=localStorage.getItem("red_private_key")||localStorage.getItem("red_mnemonic_seed")||localStorage.getItem("red_signing_key")||`${this.context.userDid}_vault_key`,i=new TextEncoder,r=await crypto.subtle.importKey("raw",i.encode(a),{name:"HMAC",hash:"SHA-256"},!1,["sign"]),o=i.encode(`${this.context.userDid}:${t}:${e}`),n=Array.from(new Uint8Array(await crypto.subtle.sign("HMAC",r,o))).map(e=>e.toString(16).padStart(2,"0")).join("");return{signature:`ed25519_hmac_sha256:${n}`,signerDid:this.context.userDid,timestamp:t,payload:e}}case"identity.verifySignature":{let{signature:e,payload:t,timestamp:a,signerPublicKey:i}=l||{};if(!e||!t||!a)return{valid:!1,timestamp:Date.now()};try{if(e.startsWith("ed25519_hmac_sha256:")||e.startsWith("hmac_sha256:")){let r=e.startsWith("ed25519_hmac_sha256:")?"ed25519_hmac_sha256:":"hmac_sha256:",o=localStorage.getItem("red_private_key")||localStorage.getItem("red_mnemonic_seed")||localStorage.getItem("red_signing_key")||`${this.context.userDid}_vault_key`,n=new TextEncoder,s=await crypto.subtle.importKey("raw",n.encode(i||o),{name:"HMAC",hash:"SHA-256"},!1,["verify"]),d=new Uint8Array(e.slice(r.length).match(/.{1,2}/g).map(e=>parseInt(e,16))),l=n.encode(`${this.context.userDid}:${a}:${t}`);return{valid:await crypto.subtle.verify("HMAC",s,d,l),timestamp:Date.now()}}return{valid:!1,timestamp:Date.now(),reason:"unknown_signature_scheme"}}catch{return{valid:!1,timestamp:Date.now(),reason:"verification_error"}}}case"mesh.broadcast":{this.requirePermission("mesh_pubsub"),this.setupMeshRouterListener();let e=l?.topic||"default",t=l?.payload,r="u">typeof crypto&&crypto.getRandomValues?Array.from(crypto.getRandomValues(new Uint8Array(4))).map(e=>e.toString(16).padStart(2,"0")).join(""):Date.now().toString(36),o=`mesh_app_${Date.now()}_${r}`,n={type:"APP_DATA",appId:this.manifest.id,msgId:o,topic:e,payload:t,timestamp:Date.now()},s=new TextEncoder().encode(JSON.stringify(n)),d=(0,i.createPacket)(this.context.userDid,"ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff",s);return await a.meshRouter.broadcast((0,i.encode)(d)),{messageId:o,status:"broadcasted"}}case"mesh.subscribe":{this.requirePermission("mesh_pubsub"),this.setupMeshRouterListener();let e=l?.topic||"default";return this.meshSubscriptions.set(e,!0),{subscribed:!0,topic:e}}case"mesh.sendDirect":{this.requirePermission("mesh_direct"),this.setupMeshRouterListener();let e=l?.targetDID;if(!e)throw Error("targetDID es requerido para sendDirect.");let t={type:"APP_DATA_DIRECT",appId:this.manifest.id,target:e,payload:l?.payload,timestamp:Date.now()},i=new TextEncoder().encode(JSON.stringify(t));return{status:await a.meshRouter.send(e,i),targetDID:e}}case"payments.requestPayment":return this.requirePermission("payments"),await t.redPaymentGateway.processPayment(l,this.context.userDid);case"payments.getBalance":let c=r.Web3BridgeEngine.getInstance();return{voucherBalance:o.MonetizationEngine.getProStatus().credits,web3:c.getState()};case"storage.getItem":this.requirePermission("storage");let p=localStorage.getItem(this.storagePrefix+l?.key);return p?JSON.parse(p):null;case"storage.setItem":if(this.requirePermission("storage"),!l?.key)throw Error("Key es requerida");return localStorage.setItem(this.storagePrefix+l.key,JSON.stringify(l.value)),{success:!0};case"storage.removeItem":return this.requirePermission("storage"),localStorage.removeItem(this.storagePrefix+l?.key),{success:!0};case"storage.clear":return this.requirePermission("storage"),Object.keys(localStorage).forEach(e=>{e.startsWith(this.storagePrefix)&&localStorage.removeItem(e)}),{success:!0};case"ai.prompt":{this.requirePermission("ai");let e=l?.query||"";if(!e.trim())return{response:"Consulta vacía.",model:"RED-LocalAI-Engine",latencyMs:0};let t=Date.now();try{let a=await (0,n.queryAICopilot)(e,this.manifest.name);return{response:a.answer,model:a.source||"RED-Unified-AI",topicCategory:a.topic_category,confidence:.95,latencyMs:a.execution_time_ms||Date.now()-t}}catch(e){return console.warn("[RedSDKBridge] queryAICopilot fallback error:",e),{response:`[RED AI]: No se pudo procesar la inferencia (${e?.message||"error"}).`,model:"RED-Local-Fallback",latencyMs:Date.now()-t}}}case"sensors.getLocation":this.requirePermission("sensors");try{let e=await d.TacticalLocationEngine.getEmergencyLocation(5e3);if(e&&d.TacticalLocationEngine.isValidCoordinates(e.lat,e.lon))return{latitude:e.lat,longitude:e.lon,altitude:e.alt??null,accuracy:e.accuracy??null,timestamp:e.timestamp}}catch{}return{latitude:null,longitude:null,altitude:null,accuracy:null,timestamp:Date.now()};case"ui.showToast":{let e=String(l?.message||l||""),t=l?.type||"info";return e&&("success"===t?s.toast.success(e):"error"===t?s.toast.error(e):"warning"===t?s.toast.warning(e):s.toast.info(e)),{shown:!0}}default:throw Error(`M\xe9todo no soportado: ${e}`)}}requirePermission(e){if(!this.context.grantedPermissions.has(e))throw Error(`Permiso denegado: La aplicaci\xf3n '${this.manifest.name}' no tiene concedido el permiso '${e}'.`)}sendResponse(e,t,a,i){if(!this.iframeWindow)return;let r={channel:"RED_SDK",type:"RED_SDK_RESPONSE",requestId:e,appId:this.manifest.id,success:t,data:a,error:i};this.iframeWindow.postMessage(r,"*")}sendEvent(e,t){if(!this.iframeWindow)return;let a={channel:"RED_SDK",type:"RED_SDK_EVENT",appId:this.manifest.id,eventName:e,payload:t};this.iframeWindow.postMessage(a,"*")}destroy(){this.unsubscribeMeshRouter&&(this.unsubscribeMeshRouter(),this.unsubscribeMeshRouter=null),this.meshSubscriptions.clear(),this.iframeWindow=null}}e.s(["RedSDKBridge",()=>l],91596);var c=e.i(43476),p=e.i(71645),m=e.i(26965),u=e.i(71164);e.s(["UniversalCheckoutModal",0,({intent:e,buyerDid:a,onClose:i,onSuccess:n})=>{let d=e.supportedRails&&e.supportedRails.length>0?e.supportedRails:["paypal","web3_usdt","lightning","offgrid_voucher"],[l,g]=(0,p.useState)(d[0]),[f,b]=(0,p.useState)(!1),[h,x]=(0,p.useState)(null),[y,v]=(0,p.useState)(null);(0,p.useEffect)(()=>m.BackHandlerRegistry.register(()=>!f&&(u.TacticalAudioEngine.playTap(),i(),!0)),[f,i]);let w=o.MonetizationEngine.getProStatus().credits;r.Web3BridgeEngine.getInstance().getState();let S=async()=>{b(!0),x(null);try{let i;switch(l){case"paypal":i=await t.redPaymentGateway.executePayPalPayment(e,a);break;case"web3_usdt":i=await t.redPaymentGateway.executeWeb3Payment(e,a);break;case"lightning":i=await t.redPaymentGateway.executeLightningPayment(e,a);break;case"offgrid_voucher":i=await t.redPaymentGateway.executeOffgridVoucherPayment(e,a);break;default:throw Error("Riel de pago no soportado.")}b(!1),v(i),u.TacticalAudioEngine.playRogerBeep(),s.toast.success("✅ ¡Pago procesado y firmado criptográficamente!")}catch(e){b(!1),x(e.message||"Error al procesar el pago."),u.TacticalAudioEngine.playWarning()}},D=e=>{try{let t=document.createElement("textarea");t.value=e,t.style.position="fixed",t.style.opacity="0",document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t),s.toast.info("📋 Hash de transacción copiado al portapapeles.")}catch{s.toast.error("Error al copiar al portapapeles.")}};return(0,c.jsx)("div",{style:{position:"fixed",inset:0,zIndex:9999,background:"rgba(2, 4, 10, 0.90)",backdropFilter:"blur(24px)",WebkitBackdropFilter:"blur(24px)",display:"flex",alignItems:"center",justifyContent:"center",padding:"12px",userSelect:"none"},children:(0,c.jsxs)("div",{style:{width:"100%",maxWidth:"460px",borderRadius:"20px",overflow:"hidden",boxShadow:"0 16px 50px rgba(0,0,0,0.85), 0 0 30px rgba(0, 230, 118, 0.15)",display:"flex",flexDirection:"column",border:"1.5px solid rgba(0, 230, 118, 0.35)",background:"linear-gradient(180deg, rgba(14,16,30,0.98) 0%, rgba(8,10,18,0.99) 100%)"},children:[(0,c.jsxs)("div",{style:{padding:"14px 16px",background:"rgba(6, 8, 16, 0.95)",borderBottom:"1px solid rgba(255, 255, 255, 0.12)",display:"flex",justifyContent:"space-between",alignItems:"center"},children:[(0,c.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"10px"},children:[(0,c.jsx)("div",{style:{width:"36px",height:"36px",borderRadius:"10px",background:"linear-gradient(135deg, rgba(0,230,118,0.2) 0%, rgba(0,229,255,0.2) 100%)",border:"1px solid rgba(0,230,118,0.4)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.2rem",boxShadow:"0 0 12px rgba(0,230,118,0.2)"},children:"💳"}),(0,c.jsxs)("div",{children:[(0,c.jsx)("h3",{style:{fontSize:"0.85rem",fontWeight:900,color:"#FFFFFF",letterSpacing:"0.5px",textTransform:"uppercase",margin:0},children:"TERMINAL DE PAGOS MULTI-RAIL"}),(0,c.jsx)("p",{style:{fontSize:"0.68rem",color:"var(--accent-cyan)",fontFamily:"JetBrains Mono, monospace",margin:"2px 0 0 0"},children:"RED Sovereign Checkout v66"})]})]}),(0,c.jsx)("button",{onClick:()=>{u.TacticalAudioEngine.playTap(),i()},style:{background:"rgba(255, 255, 255, 0.08)",border:"1px solid rgba(255, 255, 255, 0.15)",color:"#FFFFFF",width:"30px",height:"30px",borderRadius:"8px",cursor:"pointer",fontSize:"0.85rem",fontWeight:900},children:"✕"})]}),y?(0,c.jsxs)("div",{style:{padding:"20px",display:"flex",flexDirection:"column",alignItems:"center",textAlign:"center",gap:"14px"},children:[(0,c.jsx)("div",{style:{width:"64px",height:"64px",borderRadius:"20px",background:"rgba(0, 230, 118, 0.2)",border:"2px solid var(--accent-emerald)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"2rem",boxShadow:"0 0 25px rgba(0,230,118,0.4)"},children:"✅"}),(0,c.jsxs)("div",{children:[(0,c.jsx)("h4",{style:{fontSize:"1rem",fontWeight:900,color:"#FFFFFF",margin:0},children:"¡PAGO VERIFICADO EN MALLA!"}),(0,c.jsx)("p",{style:{fontSize:"0.75rem",color:"var(--accent-emerald)",fontFamily:"JetBrains Mono, monospace",margin:"4px 0 0 0"},children:"Firma Ed25519 Validada"})]}),(0,c.jsxs)("div",{style:{width:"100%",background:"rgba(0, 0, 0, 0.6)",border:"1px solid rgba(255, 255, 255, 0.1)",borderRadius:"14px",padding:"12px",textAlign:"left",fontFamily:"JetBrains Mono, monospace",fontSize:"0.72rem",display:"flex",flexDirection:"column",gap:"8px"},children:[(0,c.jsxs)("div",{style:{display:"flex",justifyContent:"space-between",borderBottom:"1px solid rgba(255, 255, 255, 0.06)",paddingBottom:"4px"},children:[(0,c.jsx)("span",{style:{color:"var(--text-muted)"},children:"Concepto:"}),(0,c.jsx)("span",{style:{color:"#FFFFFF",fontWeight:800},children:e.title})]}),(0,c.jsxs)("div",{style:{display:"flex",justifyContent:"space-between",borderBottom:"1px solid rgba(255, 255, 255, 0.06)",paddingBottom:"4px"},children:[(0,c.jsx)("span",{style:{color:"var(--text-muted)"},children:"Monto:"}),(0,c.jsxs)("span",{style:{color:"var(--accent-emerald)",fontWeight:900},children:["$",y.amount.toFixed(2)," ",y.currency]})]}),(0,c.jsxs)("div",{style:{display:"flex",justifyContent:"space-between",borderBottom:"1px solid rgba(255, 255, 255, 0.06)",paddingBottom:"4px"},children:[(0,c.jsx)("span",{style:{color:"var(--text-muted)"},children:"Riel:"}),(0,c.jsx)("span",{style:{color:"var(--accent-cyan)",textTransform:"uppercase",fontWeight:800},children:y.rail})]}),(0,c.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:"2px"},children:[(0,c.jsx)("span",{style:{color:"var(--text-muted)"},children:"Tx Hash:"}),(0,c.jsx)("span",{style:{color:"var(--text-secondary)",fontSize:"0.65rem",wordBreak:"break-all",background:"rgba(255,255,255,0.04)",padding:"6px",borderRadius:"6px"},children:y.transactionId})]})]}),(0,c.jsxs)("div",{style:{display:"flex",gap:"8px",width:"100%"},children:[(0,c.jsx)("button",{type:"button",onClick:()=>{y&&(u.TacticalAudioEngine.playTap(),"u">typeof navigator&&navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(y.transactionId).then(()=>s.toast.info("📋 Hash de transacción copiado al portapapeles.")).catch(()=>D(y.transactionId)):D(y.transactionId))},style:{flex:1,padding:"8px",background:"rgba(255, 255, 255, 0.06)",border:"1px solid rgba(255, 255, 255, 0.12)",color:"#FFFFFF",borderRadius:"10px",fontSize:"0.75rem",fontWeight:800,cursor:"pointer"},children:"📋 Copiar Hash"}),(0,c.jsx)("button",{type:"button",onClick:()=>{if(!y)return;u.TacticalAudioEngine.playTap();let e=new Blob([JSON.stringify(y,null,2)],{type:"application/json"}),t=URL.createObjectURL(e),a=document.createElement("a");a.href=t,a.download=`recibo_red_${y.transactionId.slice(0,10)}.json`,a.click(),URL.revokeObjectURL(t)},style:{flex:1,padding:"8px",background:"rgba(255, 255, 255, 0.06)",border:"1px solid rgba(255, 255, 255, 0.12)",color:"#FFFFFF",borderRadius:"10px",fontSize:"0.75rem",fontWeight:800,cursor:"pointer"},children:"💾 Guardar JSON"})]}),(0,c.jsx)("button",{type:"button",onClick:()=>{u.TacticalAudioEngine.playTap(),n(y)},style:{width:"100%",padding:"10px",background:"linear-gradient(135deg, #00E676 0%, #00E5FF 100%)",color:"#000000",fontWeight:900,borderRadius:"12px",fontSize:"0.82rem",border:"none",cursor:"pointer",boxShadow:"0 0 16px rgba(0, 230, 118, 0.35)"},children:"✓ CONTINUAR A LA MINI-APP"})]}):(0,c.jsxs)(c.Fragment,{children:[(0,c.jsxs)("div",{style:{padding:"14px 16px",background:"rgba(0, 0, 0, 0.4)",borderBottom:"1px solid rgba(255, 255, 255, 0.1)",display:"flex",justifyContent:"space-between",alignItems:"center"},children:[(0,c.jsxs)("div",{children:[(0,c.jsx)("h4",{style:{fontSize:"0.88rem",fontWeight:800,color:"#FFFFFF",margin:0},children:e.title}),(0,c.jsx)("p",{style:{fontSize:"0.75rem",color:"var(--text-secondary)",margin:"2px 0 0 0"},children:e.description||"Comercio Descentralizado RED"}),(0,c.jsxs)("p",{style:{fontSize:"0.68rem",color:"var(--text-muted)",fontFamily:"JetBrains Mono, monospace",margin:"4px 0 0 0"},children:["Comercio: ",e.merchant.name]})]}),(0,c.jsxs)("div",{style:{textAlign:"right"},children:[(0,c.jsxs)("div",{style:{fontSize:"1.4rem",fontWeight:900,color:"var(--accent-emerald)"},children:["$",e.amount.toFixed(2)]}),(0,c.jsx)("span",{style:{fontSize:"0.68rem",color:"var(--text-secondary)",textTransform:"uppercase",fontFamily:"JetBrains Mono, monospace",fontWeight:800},children:e.currency})]})]}),(0,c.jsxs)("div",{style:{padding:"16px",display:"flex",flexDirection:"column",gap:"12px"},children:[(0,c.jsx)("label",{style:{fontSize:"0.75rem",fontWeight:800,color:"var(--text-secondary)",fontFamily:"JetBrains Mono, monospace"},children:"SELECCIONA RIEL DE PAGO:"}),(0,c.jsxs)("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"8px"},children:[d.includes("paypal")&&(0,c.jsxs)("button",{type:"button",onClick:()=>{u.TacticalAudioEngine.playTap(),g("paypal")},style:{padding:"10px",borderRadius:"12px",border:"paypal"===l?"1.5px solid #3B82F6":"1px solid rgba(255, 255, 255, 0.1)",background:"paypal"===l?"rgba(59, 130, 246, 0.2)":"rgba(0, 0, 0, 0.4)",color:"#FFFFFF",display:"flex",flexDirection:"column",alignItems:"flex-start",gap:"2px",cursor:"pointer"},children:[(0,c.jsx)("span",{style:{fontSize:"0.78rem",fontWeight:800},children:"💳 PayPal / Tarjeta"}),(0,c.jsx)("span",{style:{fontSize:"0.65rem",color:"var(--text-muted)"},children:"USD / Fiat Directo"})]}),d.includes("web3_usdt")&&(0,c.jsxs)("button",{type:"button",onClick:()=>{u.TacticalAudioEngine.playTap(),g("web3_usdt")},style:{padding:"10px",borderRadius:"12px",border:"web3_usdt"===l?"1.5px solid #A855F7":"1px solid rgba(255, 255, 255, 0.1)",background:"web3_usdt"===l?"rgba(168, 85, 247, 0.2)":"rgba(0, 0, 0, 0.4)",color:"#FFFFFF",display:"flex",flexDirection:"column",alignItems:"flex-start",gap:"2px",cursor:"pointer"},children:[(0,c.jsx)("span",{style:{fontSize:"0.78rem",fontWeight:800},children:"🦊 Web3 USDT/POL"}),(0,c.jsx)("span",{style:{fontSize:"0.65rem",color:"var(--text-muted)"},children:"Polygon / EVM"})]}),d.includes("lightning")&&(0,c.jsxs)("button",{type:"button",onClick:()=>{u.TacticalAudioEngine.playTap(),g("lightning")},style:{padding:"10px",borderRadius:"12px",border:"lightning"===l?"1.5px solid #F59E0B":"1px solid rgba(255, 255, 255, 0.1)",background:"lightning"===l?"rgba(245, 158, 11, 0.2)":"rgba(0, 0, 0, 0.4)",color:"#FFFFFF",display:"flex",flexDirection:"column",alignItems:"flex-start",gap:"2px",cursor:"pointer"},children:[(0,c.jsx)("span",{style:{fontSize:"0.78rem",fontWeight:800},children:"⚡ Lightning"}),(0,c.jsx)("span",{style:{fontSize:"0.65rem",color:"var(--text-muted)"},children:"Sats Instantáneos"})]}),d.includes("offgrid_voucher")&&(0,c.jsxs)("button",{type:"button",onClick:()=>{u.TacticalAudioEngine.playTap(),g("offgrid_voucher")},style:{padding:"10px",borderRadius:"12px",border:"offgrid_voucher"===l?"1.5px solid var(--accent-emerald)":"1px solid rgba(255, 255, 255, 0.1)",background:"offgrid_voucher"===l?"rgba(0, 230, 118, 0.2)":"rgba(0, 0, 0, 0.4)",color:"#FFFFFF",display:"flex",flexDirection:"column",alignItems:"flex-start",gap:"2px",cursor:"pointer"},children:[(0,c.jsx)("span",{style:{fontSize:"0.78rem",fontWeight:800},children:"🎟️ Vale Off-Grid"}),(0,c.jsx)("span",{style:{fontSize:"0.65rem",color:"var(--text-muted)"},children:"100% Sin Internet"})]})]}),(0,c.jsxs)("div",{style:{padding:"12px",background:"rgba(0, 0, 0, 0.6)",border:"1px solid rgba(255, 255, 255, 0.1)",borderRadius:"12px",fontSize:"0.75rem",display:"flex",flexDirection:"column",gap:"6px"},children:["paypal"===l&&(0,c.jsxs)("div",{children:[(0,c.jsx)("p",{style:{color:"#FFFFFF",fontWeight:800,margin:0},children:"Pasarela Fiat / PayPal"}),(0,c.jsxs)("p",{style:{color:"var(--text-secondary)",fontSize:"0.72rem",margin:"2px 0 0 0"},children:["Destino: ",(0,c.jsxs)("span",{style:{fontFamily:"JetBrains Mono, monospace",color:"#60A5FA"},children:["@",e.merchant.paypalUsername||"redmesh"]})]})]}),"web3_usdt"===l&&(0,c.jsxs)("div",{children:[(0,c.jsx)("p",{style:{color:"#FFFFFF",fontWeight:800,margin:0},children:"Transferencia Cripto EVM (USDT / POL)"}),(0,c.jsxs)("p",{style:{color:"var(--text-secondary)",fontSize:"0.68rem",wordBreak:"break-all",margin:"2px 0 0 0"},children:["Billetera: ",(0,c.jsx)("span",{style:{fontFamily:"JetBrains Mono, monospace",color:"#C084FC"},children:e.merchant.evmAddress||"0x71C836eB3f4D4e05bE7728373b9846b41295b364"})]})]}),"lightning"===l&&(0,c.jsxs)("div",{children:[(0,c.jsx)("p",{style:{color:"#FFFFFF",fontWeight:800,margin:0},children:"Factura Bitcoin Lightning Network"}),(0,c.jsxs)("p",{style:{color:"var(--text-secondary)",fontSize:"0.72rem",margin:"2px 0 0 0"},children:["Monto Estimado: ",(0,c.jsxs)("span",{style:{color:"var(--accent-amber)",fontWeight:900},children:["~",Math.round(1500*e.amount)," SAT"]})]})]}),"offgrid_voucher"===l&&(0,c.jsxs)("div",{children:[(0,c.jsx)("p",{style:{color:"#FFFFFF",fontWeight:800,margin:0},children:"Pagaré Criptográfico Off-Grid (Ed25519)"}),(0,c.jsxs)("p",{style:{color:"var(--text-secondary)",fontSize:"0.72rem",margin:"2px 0 0 0"},children:["Tu Saldo Local: ",(0,c.jsxs)("span",{style:{color:"var(--accent-emerald)",fontWeight:900},children:[w," Créditos"]})]})]})]}),h&&(0,c.jsxs)("div",{style:{padding:"8px 12px",background:"rgba(232, 33, 58, 0.2)",border:"1px solid var(--accent-crimson)",borderRadius:"10px",color:"#FF8599",fontSize:"0.75rem"},children:["⚠️ ",h]})]}),(0,c.jsxs)("div",{style:{padding:"14px 16px",background:"rgba(6, 8, 16, 0.95)",borderTop:"1px solid rgba(255, 255, 255, 0.12)",display:"flex",gap:"8px"},children:[(0,c.jsx)("button",{type:"button",onClick:()=>{u.TacticalAudioEngine.playTap(),i()},disabled:f,style:{flex:1,padding:"10px",background:"rgba(255, 255, 255, 0.06)",border:"1px solid rgba(255, 255, 255, 0.14)",borderRadius:"12px",color:"var(--text-secondary)",fontSize:"0.78rem",fontWeight:800,cursor:"pointer"},children:"Cancelar"}),(0,c.jsx)("button",{type:"button",onClick:S,disabled:f,style:{flex:1,padding:"10px",background:"linear-gradient(135deg, #00E676 0%, #00E5FF 100%)",color:"#000000",fontWeight:900,borderRadius:"12px",fontSize:"0.78rem",border:"none",cursor:"pointer",boxShadow:"0 0 16px rgba(0, 230, 118, 0.35)",display:"flex",alignItems:"center",justifyContent:"center",gap:"6px"},children:f?(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)("span",{style:{fontSize:"0.85rem"},children:"🔄"}),(0,c.jsx)("span",{children:"Procesando..."})]}):(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)("span",{children:"CONFIRMAR PAGO"}),(0,c.jsx)("span",{children:"➔"})]})})]})]})]})})}],77319)}]);