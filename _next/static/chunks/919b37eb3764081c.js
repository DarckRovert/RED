...
</html>`}};e.s(["SovereignAppStoreModal",0,({userDid:e,onClose:p,onLaunchApp:m})=>{let[u,x]=(0,a.useState)("catalog"),[g,f]=(0,a.useState)([]),[b,h]=(0,a.useState)("all"),[y,v]=(0,a.useState)(""),[w,A]=(0,a.useState)([]),[E,S]=(0,a.useState)(""),[j,C]=(0,a.useState)("bazaar"),[R,I]=(0,a.useState)(c.bazaar.name),[T,F]=(0,a.useState)(c.bazaar.id),[D,k]=(0,a.useState)(c.bazaar.desc),[B,z]=(0,a.useState)(c.bazaar.cat),[L,P]=(0,a.useState)(c.bazaar.icon),[M,H]=(0,a.useState)(c.bazaar.permissions),[U,O]=(0,a.useState)(c.bazaar.html),[N,_]=(0,a.useState)(""),q=()=>{f(i.redAppRegistry.getAllApps())};(0,a.useEffect)(()=>{q()},[]);let W=(0,a.useMemo)(()=>g.filter(e=>e.isBuiltin).length,[g]),$=(0,a.useMemo)(()=>g.filter(e=>!e.isBuiltin).length,[g]);(0,a.useEffect)(()=>{let e=s.BackHandlerRegistry.register(()=>("catalog"!==u?(d.TacticalAudioEngine.playTap(),x("catalog")):(d.TacticalAudioEngine.playTap(),p()),!0)),t=e=>{"Escape"===e.key&&(e.preventDefault(),"catalog"!==u?(d.TacticalAudioEngine.playTap(),x("catalog")):(d.TacticalAudioEngine.playTap(),p()))};return window.addEventListener("keydown",t),()=>{e(),window.removeEventListener("keydown",t)}},[u,p]),(0,a.useEffect)(()=>{let e=o.meshRouter.onLocalDelivery(e=>{try{let t=new TextDecoder().decode(e.payload);if(!t.startsWith("{"))return;let a=JSON.parse(t);("MINIAPP_PACKAGE_BROADCAST"===a.type||"MINIAPP_MANIFEST"===a.type)&&a.manifest&&a.appId&&A(t=>t.some(e=>e.appId===a.appId)?t:(d.TacticalAudioEngine.playMessageReceived(),l.toast.info(`📡 dApp recibida por radio/malla: ${a.manifest.name}`),[{appId:a.appId,manifest:a.manifest,pkg:a.pkg||null,authorDid:a.authorDid||e.sender,timestamp:a.timestamp||Date.now()},...t]))}catch{}});return()=>{e()}},[]);let K=async(e,t="Texto")=>{if(d.TacticalAudioEngine.playTap(),navigator?.clipboard?.writeText)try{await navigator.clipboard.writeText(e),l.toast.info(`📋 ${t} copiado al portapapeles.`);return}catch{}try{let a=document.createElement("textarea");a.value=e,a.style.position="fixed",a.style.opacity="0",a.style.pointerEvents="none",document.body.appendChild(a),a.select(),document.execCommand("copy"),document.body.removeChild(a),l.toast.info(`📋 ${t} copiado al portapapeles.`)}catch{l.toast.error(`No se pudo copiar ${t.toLowerCase()}.`)}};(0,a.useEffect)(()=>{if("creator"===u){let t={manifest:{id:T||"preview.app",name:R||"Vista Previa",version:"1.0.0",description:D||"",author:{name:"Operador Local",did:e},icon:L||"⚡",category:B,permissions:M,entryPoint:"index.html",createdAt:Date.now(),updatedAt:Date.now()},files:{"index.html":U}},a=r.RedAppBundleEngine.createBlobUrl(t);return _(a),()=>{a&&URL.revokeObjectURL(a)}}},[u,U,T,R,B,M,L,e]);let V=e=>{d.TacticalAudioEngine.playTap();let t=e.trim();if(!t){d.TacticalAudioEngine.playWarning(),l.toast.error("El paquete o texto está vacío.");return}try{if(t.startsWith("RED_APP_V1:")||t.includes('"format":"RED_APP_PACKAGE_V1"')){let e=i.redAppRegistry.importAppPackage(t);if(e.isValid&&e.bundle){i.redAppRegistry.installApp(e.bundle),q(),d.TacticalAudioEngine.playMessageSent(),l.toast.success(`\xa1Mini-App '${e.bundle.manifest.name}' instalada exitosamente!`),S(""),x("catalog");return}if(e.error)throw Error(e.error)}let e=r.RedAppBundleEngine.importBundle(t);i.redAppRegistry.installApp(e),q(),d.TacticalAudioEngine.playMessageSent(),l.toast.success(`\xa1Mini-App '${e.manifest.name}' instalada exitosamente!`),S(""),x("catalog")}catch(e){d.TacticalAudioEngine.playWarning(),l.toast.error(`Error al importar: ${e.message||"Formato no reconocido"}`)}},J=(0,a.useMemo)(()=>g.filter(e=>{let t="all"===b||e.manifest.category===b,a=e.manifest.name.toLowerCase().includes(y.toLowerCase())||e.manifest.description.toLowerCase().includes(y.toLowerCase())||e.manifest.id.toLowerCase().includes(y.toLowerCase());return t&&a}),[g,b,y]);return(0,t.jsx)("div",{style:{position:"fixed",inset:0,zIndex:9999,background:"rgba(2, 4, 10, 0.90)",backdropFilter:"blur(24px)",WebkitBackdropFilter:"blur(24px)",display:"flex",alignItems:"center",justifyContent:"center",padding:"12px",userSelect:"none"},children:(0,t.jsxs)("div",{style:{width:"100%",maxWidth:"1040px",height:"92vh",maxHeight:"880px",borderRadius:"20px",boxShadow:"0 16px 50px rgba(0,0,0,0.85), 0 0 30px rgba(0, 230, 118, 0.15)",display:"flex",flexDirection:"column",overflow:"hidden",border:"1.5px solid rgba(0, 230, 118, 0.35)",background:"linear-gradient(180deg, rgba(14,18,34,0.98) 0%, rgba(6,8,16,0.99) 100%)"},children:[(0,t.jsxs)("div",{style:{padding:"12px 16px",background:"rgba(6, 8, 16, 0.95)",borderBottom:"1px solid rgba(255, 255, 255, 0.12)",display:"flex",flexWrap:"wrap",gap:"12px",justifyContent:"space-between",alignItems:"center"},children:[(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"12px"},children:[(0,t.jsx)("div",{style:{width:"40px",height:"40px",borderRadius:"12px",background:"linear-gradient(135deg, rgba(0,230,118,0.2) 0%, rgba(0,229,255,0.2) 100%)",border:"1px solid rgba(0,230,118,0.4)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.4rem",boxShadow:"0 0 15px rgba(0,230,118,0.2)"},children:"🏬"}),(0,t.jsxs)("div",{children:[(0,t.jsx)("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:(0,t.jsxs)("h2",{style:{fontSize:"1rem",fontWeight:900,color:"#FFFFFF",letterSpacing:"0.5px",margin:0,display:"flex",alignItems:"center",gap:"8px"},children:["SOVEREIGN APP STORE",(0,t.jsx)("span",{style:{fontSize:"0.65rem",padding:"2px 6px",background:"rgba(0, 230, 118, 0.15)",border:"1px solid rgba(0, 230, 118, 0.5)",color:"var(--accent-emerald)",borderRadius:"4px",fontFamily:"JetBrains Mono, monospace",fontWeight:800},children:"v66.0.0"})]})}),(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"8px",fontSize:"0.72rem",color:"var(--text-muted)",fontFamily:"JetBrains Mono, monospace",marginTop:"2px"},children:[(0,t.jsx)("span",{style:{width:"6px",height:"6px",borderRadius:"50%",background:"var(--accent-emerald)",display:"inline-block"}}),(0,t.jsx)("span",{style:{maxWidth:"160px",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:e}),(0,t.jsx)("span",{children:"•"}),(0,t.jsxs)("span",{style:{color:"var(--accent-cyan)",fontWeight:700},children:[g.length," dApps"]})]})]})]}),(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[(0,t.jsx)("button",{type:"button",onClick:()=>{d.TacticalAudioEngine.playTap(),x("creator"===u?"catalog":"creator")},style:{padding:"6px 14px",borderRadius:"10px",fontSize:"0.78rem",fontWeight:900,cursor:"pointer",border:"none",background:"creator"===u?"var(--accent-emerald)":"linear-gradient(135deg, #00E676 0%, #00E5FF 100%)",color:"#000000",boxShadow:"0 0 12px rgba(0, 230, 118, 0.3)"},children:(0,t.jsx)("span",{children:"creator"===u?"📦 Ver Catálogo":"➕ Crear Mini-App"})}),(0,t.jsx)("button",{type:"button",onClick:()=>{d.TacticalAudioEngine.playTap(),p()},style:{background:"rgba(255, 255, 255, 0.08)",border:"1px solid rgba(255, 255, 255, 0.15)",color:"#FFFFFF",width:"32px",height:"32px",borderRadius:"8px",cursor:"pointer",fontSize:"0.9rem",fontWeight:900},title:"Cerrar tienda",children:"✕"})]})]}),(0,t.jsxs)("div",{style:{padding:"6px 16px",background:"rgba(3, 7, 18, 0.92)",borderBottom:"1px solid rgba(255, 255, 255, 0.08)",display:"flex",flexWrap:"wrap",alignItems:"center",justifyContent:"space-between",gap:"10px",fontSize:"0.72rem",fontFamily:"JetBrains Mono, monospace"},children:[(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"12px",flexWrap:"wrap"},children:[(0,t.jsxs)("span",{style:{color:"#E2E8F0",display:"flex",alignItems:"center",gap:"4px"},children:["📦 ",(0,t.jsx)("strong",{style:{color:"var(--accent-emerald)"},children:g.length})," Total"]}),(0,t.jsx)("span",{style:{color:"#94A3B8"},children:"|"}),(0,t.jsxs)("span",{style:{color:"#94A3B8",display:"flex",alignItems:"center",gap:"4px"},children:["🛡️ ",(0,t.jsx)("strong",{style:{color:"var(--accent-cyan)"},children:W})," Oficiales"]}),(0,t.jsx)("span",{style:{color:"#94A3B8"},children:"|"}),(0,t.jsxs)("span",{style:{color:"#94A3B8",display:"flex",alignItems:"center",gap:"4px"},children:["⚡ ",(0,t.jsx)("strong",{style:{color:"#FFD700"},children:$})," Soberanas"]}),w.length>0&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("span",{style:{color:"#94A3B8"},children:"|"}),(0,t.jsxs)("span",{style:{color:"var(--accent-cyan)",display:"flex",alignItems:"center",gap:"4px",background:"rgba(0, 229, 255, 0.1)",padding:"1px 6px",borderRadius:"4px",border:"1px solid rgba(0, 229, 255, 0.3)"},children:["📡 ",(0,t.jsx)("strong",{children:w.length})," en Malla"]})]})]}),(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"12px",color:"var(--text-muted)"},children:[(0,t.jsxs)("span",{style:{display:"flex",alignItems:"center",gap:"5px"},children:[(0,t.jsx)("span",{style:{width:"6px",height:"6px",borderRadius:"50%",background:"#00E676"}}),(0,t.jsx)("span",{children:"Malla P2P Activa"})]}),(0,t.jsx)("span",{style:{display:"flex",alignItems:"center",gap:"5px"},children:(0,t.jsx)("span",{children:"🔒 Sandbox Iframe Aislado"})})]})]}),(0,t.jsxs)("div",{style:{padding:"8px 16px",background:"rgba(6, 8, 16, 0.6)",borderBottom:"1px solid rgba(255, 255, 255, 0.08)",display:"flex",flexWrap:"wrap",gap:"8px",alignItems:"center",justifyContent:"space-between"},children:[(0,t.jsx)("div",{style:{display:"flex",gap:"6px",overflowX:"auto"},children:[{id:"catalog",label:"📦 Catálogo Soberano",count:g.length},{id:"creator",label:"🛠️ Creador & Live Preview",count:null},{id:"import",label:"📥 Importar Paquete",count:null},{id:"mesh",label:"📡 Malla P2P",count:w.length>0?w.length:null}].map(e=>(0,t.jsxs)("button",{type:"button",onClick:()=>{d.TacticalAudioEngine.playTap(),x(e.id)},style:{padding:"6px 12px",borderRadius:"8px",fontSize:"0.78rem",fontWeight:800,cursor:"pointer",border:u===e.id?"1px solid var(--accent-emerald)":"1px solid transparent",background:u===e.id?"rgba(0, 230, 118, 0.15)":"transparent",color:u===e.id?"var(--accent-emerald)":"var(--text-secondary)",display:"flex",alignItems:"center"},children:[(0,t.jsx)("span",{children:e.label}),null!==e.count&&(0,t.jsx)("span",{style:{fontSize:"0.68rem",padding:"1px 6px",background:"rgba(255,255,255,0.1)",borderRadius:"10px",marginLeft:"6px",fontFamily:"JetBrains Mono, monospace"},children:e.count})]},e.id))}),"catalog"===u&&(0,t.jsx)("div",{style:{width:"240px"},children:(0,t.jsx)("input",{type:"text",placeholder:"🔍 Buscar Mini-Apps...",value:y,onChange:e=>v(e.target.value),className:"tactical-input",style:{width:"100%",padding:"6px 10px",fontSize:"0.78rem"}})})]}),"catalog"===u&&(0,t.jsxs)("div",{style:{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"},children:[(0,t.jsx)("div",{style:{padding:"8px 16px",borderBottom:"1px solid rgba(255, 255, 255, 0.08)",display:"flex",gap:"6px",overflowX:"auto"},children:[{id:"all",label:"Todas las Apps"},{id:"market",label:"🛒 Mercado P2P"},{id:"utility",label:"🔧 Utilidades"},{id:"emergency",label:"🩹 Emergencia"},{id:"games",label:"🎮 Juegos"}].map(e=>(0,t.jsx)("button",{type:"button",onClick:()=>{d.TacticalAudioEngine.playTap(),h(e.id)},style:{padding:"4px 10px",borderRadius:"8px",fontSize:"0.75rem",fontWeight:800,cursor:"pointer",border:b===e.id?"1px solid var(--accent-cyan)":"1px solid rgba(255, 255, 255, 0.08)",background:b===e.id?"rgba(0, 229, 255, 0.15)":"rgba(255, 255, 255, 0.03)",color:b===e.id?"var(--accent-cyan)":"var(--text-secondary)",whiteSpace:"nowrap"},children:e.label},e.id))}),(0,t.jsx)("div",{style:{flex:1,overflowY:"auto",padding:"16px",display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(280px, 1fr))",gap:"14px"},children:J.map(a=>(0,t.jsxs)("div",{style:{background:"linear-gradient(180deg, rgba(16, 22, 44, 0.8) 0%, rgba(8, 12, 26, 0.9) 100%)",border:"1px solid rgba(255, 255, 255, 0.12)",borderRadius:"16px",padding:"14px",display:"flex",flexDirection:"column",justifyContent:"space-between",boxShadow:"0 4px 16px rgba(0, 0, 0, 0.5)"},children:[(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{style:{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:"10px",marginBottom:"10px"},children:[(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"10px"},children:[(0,t.jsx)("div",{style:{width:"44px",height:"44px",borderRadius:"12px",background:"rgba(0, 0, 0, 0.6)",border:"1px solid rgba(255, 255, 255, 0.15)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.5rem"},children:a.manifest.icon||"📱"}),(0,t.jsxs)("div",{children:[(0,t.jsx)("h3",{style:{fontSize:"0.88rem",fontWeight:900,color:"#FFFFFF",margin:0},children:a.manifest.name}),(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"6px",fontSize:"0.68rem",color:"var(--text-muted)",fontFamily:"JetBrains Mono, monospace",marginTop:"2px"},children:[(0,t.jsxs)("span",{children:["v",a.manifest.version]}),(0,t.jsx)("span",{children:"•"}),(0,t.jsx)("span",{style:{textTransform:"uppercase",color:"var(--accent-emerald)",fontWeight:800},children:a.manifest.category})]})]})]}),a.isBuiltin?(0,t.jsx)("span",{style:{fontSize:"0.62rem",padding:"2px 6px",background:"rgba(0, 230, 118, 0.15)",border:"1px solid rgba(0, 230, 118, 0.5)",color:"var(--accent-emerald)",borderRadius:"6px",fontWeight:900,textTransform:"uppercase"},children:"Oficial"}):(0,t.jsx)("span",{style:{fontSize:"0.62rem",padding:"2px 6px",background:"rgba(0, 229, 255, 0.15)",border:"1px solid rgba(0, 229, 255, 0.5)",color:"var(--accent-cyan)",borderRadius:"6px",fontWeight:900,textTransform:"uppercase"},children:"Soberana"})]}),(0,t.jsx)("p",{style:{fontSize:"0.78rem",color:"var(--text-secondary)",margin:"0 0 10px 0",lineHeight:1.4},children:a.manifest.description}),(0,t.jsx)("div",{style:{display:"flex",flexWrap:"wrap",gap:"4px",marginBottom:"12px"},children:a.manifest.permissions.map(e=>(0,t.jsxs)("span",{style:{fontSize:"0.64rem",padding:"2px 6px",background:"rgba(0, 0, 0, 0.5)",border:"1px solid rgba(255, 255, 255, 0.08)",color:"var(--text-secondary)",borderRadius:"4px",fontFamily:"JetBrains Mono, monospace"},children:["🔒 ",e]},e))})]}),(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",paddingTop:"10px",borderTop:"1px solid rgba(255, 255, 255, 0.08)",marginTop:"auto"},children:[(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"6px"},children:[(0,t.jsx)("button",{type:"button",onClick:()=>(t=>{d.TacticalAudioEngine.playTap();try{let a=i.redAppRegistry.exportAppPackage(t.manifest.id),r={type:"MINIAPP_PACKAGE_BROADCAST",appId:t.manifest.id,manifest:t.manifest,pkg:a,authorDid:e,timestamp:Date.now()},s=new TextEncoder().encode(JSON.stringify(r));o.meshRouter.broadcast((0,n.encode)((0,n.createPacket)(e,"broadcast",s))),d.TacticalAudioEngine.playMessageSent(),l.toast.success(`📡 Mini-App '${t.manifest.name}' transmitida por radio/mesh.`)}catch(e){d.TacticalAudioEngine.playWarning(),l.toast.error(`Error al transmitir: ${e.message}`)}})(a.bundle),style:{padding:"6px 8px",background:"rgba(255, 255, 255, 0.06)",border:"1px solid rgba(255, 255, 255, 0.12)",color:"#FFFFFF",borderRadius:"8px",fontSize:"0.75rem",cursor:"pointer"},title:"Transmitir paquete por radio/malla",children:"📡"}),(0,t.jsx)("button",{type:"button",onClick:()=>{var e;let t,r,o;return e=a.bundle,d.TacticalAudioEngine.playTap(),t=new Blob([i.redAppRegistry.exportAppPackage(e.manifest.id)||JSON.stringify(e,null,2)],{type:"application/json"}),r=URL.createObjectURL(t),void((o=document.createElement("a")).href=r,o.download=`${e.manifest.id}.redapp`,o.click(),URL.revokeObjectURL(r),d.TacticalAudioEngine.playMessageSent(),l.toast.info(`📦 Paquete firmado ${e.manifest.name} exportado.`))},style:{padding:"6px 8px",background:"rgba(255, 255, 255, 0.06)",border:"1px solid rgba(255, 255, 255, 0.12)",color:"#FFFFFF",borderRadius:"8px",fontSize:"0.75rem",cursor:"pointer"},title:"Exportar archivo .redapp",children:"💾"}),(0,t.jsx)("button",{type:"button",onClick:()=>K(a.manifest.id,"App ID"),style:{padding:"6px 8px",background:"rgba(255, 255, 255, 0.06)",border:"1px solid rgba(255, 255, 255, 0.12)",color:"#FFFFFF",borderRadius:"8px",fontSize:"0.75rem",cursor:"pointer"},title:"Copiar App ID",children:"📋"}),!a.isBuiltin&&(0,t.jsx)("button",{type:"button",onClick:()=>{var e;return e=a.manifest.id,void(d.TacticalAudioEngine.playTap(),i.redAppRegistry.uninstallApp(e)?(l.toast.info("Mini-App desinstalada."),q()):(d.TacticalAudioEngine.playWarning(),l.toast.error("No se pueden desinstalar aplicaciones nativas del sistema.")))},style:{padding:"6px 8px",background:"rgba(232, 33, 58, 0.15)",border:"1px solid rgba(232, 33, 58, 0.4)",color:"var(--accent-crimson)",borderRadius:"8px",fontSize:"0.75rem",cursor:"pointer"},title:"Eliminar Mini-App local",children:"🗑️"})]}),(0,t.jsxs)("button",{type:"button",onClick:()=>{d.TacticalAudioEngine.playTap(),m(a.bundle)},style:{padding:"6px 14px",background:"linear-gradient(135deg, #00E676 0%, #00E5FF 100%)",color:"#000000",fontWeight:900,borderRadius:"10px",fontSize:"0.78rem",border:"none",cursor:"pointer",boxShadow:"0 0 10px rgba(0, 230, 118, 0.3)",display:"flex",alignItems:"center",gap:"6px"},children:[(0,t.jsx)("span",{children:"EJECUTAR"}),(0,t.jsx)("span",{children:"➔"})]})]})]},a.manifest.id))})]}),"creator"===u&&(0,t.jsxs)("div",{style:{flex:1,display:"flex",flexDirection:"row",overflow:"hidden"},children:[(0,t.jsxs)("div",{style:{flex:1,padding:"16px",overflowY:"auto",borderRight:"1px solid rgba(255, 255, 255, 0.1)",display:"flex",flexDirection:"column",gap:"12px",fontSize:"0.78rem"},children:[(0,t.jsxs)("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[(0,t.jsx)("h3",{style:{fontSize:"0.88rem",fontWeight:900,color:"#FFFFFF",margin:0,display:"flex",alignItems:"center",gap:"6px"},children:(0,t.jsx)("span",{children:"🛠️ Creador & Editor de dApps"})}),(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[(0,t.jsx)("span",{style:{color:"var(--text-muted)"},children:"Plantilla:"}),(0,t.jsxs)("select",{value:j,onChange:e=>{var t;let a;return t=e.target.value,d.TacticalAudioEngine.playTap(),void((a=c[t])&&(C(t),I(a.name),F(a.id),k(a.desc),z(a.cat),P(a.icon),H(a.permissions),O(a.html)))},style:{padding:"4px 8px",background:"rgba(0,0,0,0.6)",border:"1px solid rgba(0, 230, 118, 0.4)",color:"var(--accent-emerald)",borderRadius:"8px",fontWeight:800,fontFamily:"JetBrains Mono, monospace",outline:"none"},children:[(0,t.jsx)("option",{value:"bazaar",children:"🛒 Tienda / Trueque P2P"}),(0,t.jsx)("option",{value:"game",children:"🎮 Batalla Naval Malla"}),(0,t.jsx)("option",{value:"notes",children:"🔒 Bloc Criptográfico"})]})]})]}),(0,t.jsxs)("form",{onSubmit:t=>{if(t.preventDefault(),d.TacticalAudioEngine.playTap(),!R.trim()||!T.trim()){d.TacticalAudioEngine.playWarning(),l.toast.error("El nombre y el App ID son obligatorios.");return}let a={id:T.trim().toLowerCase(),name:R.trim(),version:"1.0.0",description:D.trim(),author:{name:"Operador Soberano",did:e},icon:L.trim()||"📱",category:B,permissions:M,entryPoint:"index.html",createdAt:Date.now(),updatedAt:Date.now()},r={manifest:a,files:{"index.html":U}};i.redAppRegistry.installApp(r);try{let t={type:"MINIAPP_MANIFEST",appId:a.id,manifest:a,timestamp:Date.now()},i=new TextEncoder().encode(JSON.stringify(t));o.meshRouter.broadcast((0,n.encode)((0,n.createPacket)(e,"broadcast",i)))}catch{}d.TacticalAudioEngine.playMessageSent(),l.toast.success(`🚀 Mini-App '${a.name}' instalada y transmitida a la malla.`),q(),x("catalog"),m(r)},style:{display:"flex",flexDirection:"column",gap:"10px"},children:[(0,t.jsxs)("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"10px"},children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{style:{display:"block",color:"var(--text-secondary)",fontWeight:700,marginBottom:"4px"},children:"Nombre de la Aplicación"}),(0,t.jsx)("input",{type:"text",required:!0,value:R,onChange:e=>I(e.target.value),placeholder:"Mi Calculadora Solar",className:"tactical-input",style:{width:"100%"}})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{style:{display:"block",color:"var(--text-secondary)",fontWeight:700,marginBottom:"4px"},children:"App ID Único (Reverse DNS)"}),(0,t.jsx)("input",{type:"text",required:!0,value:T,onChange:e=>F(e.target.value),placeholder:"com.usuario.solar",className:"tactical-input",style:{width:"100%",fontFamily:"JetBrains Mono, monospace"}})]})]}),(0,t.jsxs)("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"10px"},children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{style:{display:"block",color:"var(--text-secondary)",fontWeight:700,marginBottom:"4px"},children:"Categoría"}),(0,t.jsxs)("select",{value:B,onChange:e=>z(e.target.value),className:"tactical-input",style:{width:"100%"},children:[(0,t.jsx)("option",{value:"utility",children:"Utilidad"}),(0,t.jsx)("option",{value:"market",children:"Mercado"}),(0,t.jsx)("option",{value:"emergency",children:"Emergencia"}),(0,t.jsx)("option",{value:"games",children:"Juegos"})]})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{style:{display:"block",color:"var(--text-secondary)",fontWeight:700,marginBottom:"4px"},children:"Emoji / Icono"}),(0,t.jsx)("input",{type:"text",value:L,onChange:e=>P(e.target.value),className:"tactical-input",style:{width:"100%",textAlign:"center",fontSize:"1.2rem"}})]})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{style:{display:"block",color:"var(--text-secondary)",fontWeight:700,marginBottom:"4px"},children:"Descripción"}),(0,t.jsx)("input",{type:"text",value:D,onChange:e=>k(e.target.value),placeholder:"Descripción breve de la utilidad...",className:"tactical-input",style:{width:"100%"}})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{style:{display:"block",color:"var(--text-secondary)",fontWeight:700,marginBottom:"4px"},children:"Permisos Solicitados"}),(0,t.jsx)("div",{style:{display:"flex",flexWrap:"wrap",gap:"6px"},children:["identity","mesh_pubsub","payments","storage","ai","sensors"].map(e=>{let a=M.includes(e);return(0,t.jsxs)("button",{type:"button",onClick:()=>{d.TacticalAudioEngine.playTap(),M.includes(e)?H(M.filter(t=>t!==e)):H([...M,e])},style:{padding:"4px 8px",borderRadius:"6px",fontSize:"0.68rem",fontFamily:"JetBrains Mono, monospace",fontWeight:800,cursor:"pointer",border:a?"1px solid var(--accent-emerald)":"1px solid rgba(255,255,255,0.1)",background:a?"rgba(0, 230, 118, 0.2)":"rgba(0,0,0,0.4)",color:a?"var(--accent-emerald)":"var(--text-muted)"},children:[a?"✓ ":"+ "," ",e]},e)})})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{style:{display:"block",color:"var(--text-secondary)",fontWeight:700,marginBottom:"4px"},children:"Código Fuente Sandboxed (`index.html`)"}),(0,t.jsx)("textarea",{rows:10,value:U,onChange:e=>O(e.target.value),className:"tactical-input",style:{width:"100%",color:"var(--accent-emerald)",fontFamily:"JetBrains Mono, monospace",fontSize:"0.72rem",lineHeight:1.4},spellCheck:!1})]}),(0,t.jsx)("button",{type:"submit",style:{width:"100%",padding:"10px",background:"linear-gradient(135deg, #00E676 0%, #00E5FF 100%)",color:"#000000",fontWeight:900,borderRadius:"12px",fontSize:"0.82rem",border:"none",cursor:"pointer",boxShadow:"0 0 16px rgba(0, 230, 118, 0.35)"},children:"🚀 INSTALAR & EMITIR PAQUETE A LA MALLA"})]})]}),(0,t.jsxs)("div",{style:{flex:1,background:"rgba(0, 0, 0, 0.8)",padding:"16px",display:"flex",flexDirection:"column"},children:[(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",paddingBottom:"8px",marginBottom:"8px",borderBottom:"1px solid rgba(255, 255, 255, 0.1)"},children:[(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[(0,t.jsx)("span",{style:{width:"8px",height:"8px",borderRadius:"50%",background:"var(--accent-emerald)"}}),(0,t.jsx)("span",{style:{fontSize:"0.78rem",fontWeight:800,color:"#FFFFFF"},children:"VISTA PREVIA EN VIVO (SANDBOX)"})]}),(0,t.jsx)("span",{style:{fontSize:"0.68rem",color:"var(--accent-cyan)",fontFamily:"JetBrains Mono, monospace"},children:"window.RedSDK Activo"})]}),(0,t.jsx)("div",{style:{flex:1,background:"#020306",borderRadius:"14px",overflow:"hidden",border:"1px solid rgba(255, 255, 255, 0.12)",position:"relative"},children:N?(0,t.jsx)("iframe",{src:N,title:"Live Preview",sandbox:"allow-scripts allow-forms",style:{width:"100%",height:"100%",border:"none",background:"#020306"}}):(0,t.jsx)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",height:"100%",color:"var(--text-muted)",fontSize:"0.75rem"},children:"Generando sandbox..."})})]})]}),"import"===u&&(0,t.jsxs)("div",{style:{flex:1,overflowY:"auto",padding:"20px",display:"flex",flexDirection:"column",gap:"16px"},children:[(0,t.jsxs)("div",{style:{background:"rgba(10, 14, 28, 0.7)",border:"1px solid rgba(255, 255, 255, 0.12)",borderRadius:"16px",padding:"20px"},children:[(0,t.jsxs)("h3",{style:{fontSize:"0.95rem",fontWeight:900,color:"#FFFFFF",margin:"0 0 8px 0",display:"flex",alignItems:"center",gap:"8px"},children:["📁 ",(0,t.jsx)("span",{children:"Cargar Archivo de Aplicación"})]}),(0,t.jsxs)("p",{style:{fontSize:"0.78rem",color:"var(--text-secondary)",margin:"0 0 16px 0",lineHeight:1.4},children:["Selecciona un archivo ",(0,t.jsx)("code",{children:".redapp"})," firmado digitalmente o un manifiesto ",(0,t.jsx)("code",{children:".json"})," exportado previamente."]}),(0,t.jsxs)("label",{style:{display:"inline-flex",alignItems:"center",gap:"8px",padding:"10px 18px",background:"linear-gradient(135deg, rgba(0,230,118,0.2) 0%, rgba(0,229,255,0.2) 100%)",border:"1px solid rgba(0, 230, 118, 0.4)",borderRadius:"10px",color:"var(--accent-emerald)",fontWeight:900,fontSize:"0.82rem",cursor:"pointer"},children:[(0,t.jsx)("span",{children:"📥 Seleccionar Archivo (.redapp / .json)"}),(0,t.jsx)("input",{type:"file",accept:".json,.redapp",onChange:e=>{let t=e.target.files?.[0];if(!t)return;let a=new FileReader;a.onload=e=>{let t=e.target?.result;t&&V(t)},a.readAsText(t)},style:{display:"none"}})]})]}),(0,t.jsxs)("div",{style:{background:"rgba(10, 14, 28, 0.7)",border:"1px solid rgba(255, 255, 255, 0.12)",borderRadius:"16px",padding:"20px",display:"flex",flexDirection:"column",gap:"12px"},children:[(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between"},children:[(0,t.jsxs)("h3",{style:{fontSize:"0.95rem",fontWeight:900,color:"#FFFFFF",margin:0,display:"flex",alignItems:"center",gap:"8px"},children:["📋 ",(0,t.jsx)("span",{children:"Pegar Paquete Codificado (Air-Gap / Portapapeles)"})]}),(0,t.jsx)("span",{style:{fontSize:"0.68rem",color:"var(--accent-cyan)",fontFamily:"JetBrains Mono, monospace"},children:"Formatos: RED_APP_V1:* o JSON Raw"})]}),(0,t.jsx)("p",{style:{fontSize:"0.78rem",color:"var(--text-secondary)",margin:0,lineHeight:1.4},children:"Para dispositivos tácticos aislados sin acceso al explorador de archivos del sistema, pega la cadena Base64 o el contenido del paquete directamente:"}),(0,t.jsx)("textarea",{rows:6,value:E,onChange:e=>S(e.target.value),placeholder:"Pega aquí el paquete RED_APP_V1:... o JSON de la Mini-App...",className:"tactical-input",style:{width:"100%",fontFamily:"JetBrains Mono, monospace",fontSize:"0.75rem",color:"var(--accent-emerald)"}}),(0,t.jsxs)("div",{style:{display:"flex",gap:"10px",justifyContent:"flex-end"},children:[E&&(0,t.jsx)("button",{type:"button",onClick:()=>{d.TacticalAudioEngine.playTap(),S("")},style:{padding:"8px 14px",background:"rgba(255, 255, 255, 0.06)",border:"1px solid rgba(255, 255, 255, 0.14)",borderRadius:"8px",color:"#FFFFFF",fontSize:"0.78rem",fontWeight:700,cursor:"pointer"},children:"Limpiar"}),(0,t.jsx)("button",{type:"button",onClick:()=>V(E),disabled:!E.trim(),style:{padding:"8px 18px",background:E.trim()?"linear-gradient(135deg, #00E676 0%, #00E5FF 100%)":"rgba(255, 255, 255, 0.1)",border:"none",borderRadius:"8px",color:E.trim()?"#000000":"var(--text-muted)",fontSize:"0.78rem",fontWeight:900,cursor:E.trim()?"pointer":"not-allowed"},children:"⚡ Instalar Paquete"})]})]})]}),"mesh"===u&&(0,t.jsxs)("div",{style:{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",padding:"16px"},children:[(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"12px"},children:[(0,t.jsxs)("div",{children:[(0,t.jsxs)("h3",{style:{fontSize:"0.95rem",fontWeight:900,color:"#FFFFFF",margin:0,display:"flex",alignItems:"center",gap:"8px"},children:["📡 ",(0,t.jsx)("span",{children:"Micro-Aplicaciones en la Malla P2P"}),(0,t.jsxs)("span",{style:{fontSize:"0.68rem",padding:"2px 8px",background:"rgba(0, 230, 118, 0.15)",border:"1px solid rgba(0, 230, 118, 0.4)",color:"var(--accent-emerald)",borderRadius:"10px",fontFamily:"JetBrains Mono, monospace"},children:[w.length," Detectadas"]})]}),(0,t.jsx)("p",{style:{fontSize:"0.75rem",color:"var(--text-secondary)",margin:"4px 0 0 0"},children:"Paquetes y manifiestos de aplicaciones recibidos en vivo a través de canales de radio LoRa, Bluetooth LE y WiFi-Direct."})]}),w.length>0&&(0,t.jsx)("button",{type:"button",onClick:()=>{d.TacticalAudioEngine.playTap(),A([]),l.toast.info("Historial de paquetes de malla limpiado.")},style:{padding:"6px 12px",background:"rgba(255, 255, 255, 0.06)",border:"1px solid rgba(255, 255, 255, 0.12)",color:"#FFFFFF",borderRadius:"8px",fontSize:"0.72rem",cursor:"pointer"},children:"Limpiar Registro"})]}),0===w.length?(0,t.jsxs)("div",{style:{flex:1,border:"1px dashed rgba(255, 255, 255, 0.15)",borderRadius:"16px",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:"10px",color:"var(--text-muted)",textAlign:"center",padding:"24px"},children:[(0,t.jsx)("div",{style:{fontSize:"2.5rem"},children:"📡"}),(0,t.jsx)("div",{style:{fontSize:"0.9rem",fontWeight:800,color:"#E2E8F0"},children:"Transceptor a la Escucha en Canales de Radio"}),(0,t.jsx)("p",{style:{fontSize:"0.75rem",maxWidth:"420px",margin:0,lineHeight:1.5},children:"Cuando los nodos de tu escuadrón o base transmitan aplicaciones soberanas mediante la red de malla descentralizada, aparecerán aquí automáticamente para su instalación con un clic."})]}):(0,t.jsx)("div",{style:{flex:1,overflowY:"auto",display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(300px, 1fr))",gap:"12px"},children:w.map(e=>(0,t.jsxs)("div",{style:{background:"linear-gradient(180deg, rgba(16, 22, 44, 0.8) 0%, rgba(8, 12, 26, 0.9) 100%)",border:"1px solid rgba(0, 229, 255, 0.25)",borderRadius:"14px",padding:"14px",display:"flex",flexDirection:"column",justifyContent:"space-between",boxShadow:"0 4px 16px rgba(0, 0, 0, 0.5)"},children:[(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"10px",marginBottom:"8px"},children:[(0,t.jsx)("div",{style:{width:"40px",height:"40px",borderRadius:"10px",background:"rgba(0, 229, 255, 0.1)",border:"1px solid rgba(0, 229, 255, 0.3)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.3rem"},children:e.manifest.icon||"📱"}),(0,t.jsxs)("div",{children:[(0,t.jsx)("h4",{style:{fontSize:"0.85rem",fontWeight:900,color:"#FFFFFF",margin:0},children:e.manifest.name}),(0,t.jsxs)("div",{style:{fontSize:"0.68rem",color:"var(--accent-cyan)",fontFamily:"JetBrains Mono, monospace"},children:["v",e.manifest.version," • ",e.manifest.category]})]})]}),(0,t.jsx)("p",{style:{fontSize:"0.75rem",color:"var(--text-secondary)",margin:"0 0 8px 0",lineHeight:1.3},children:e.manifest.description}),(0,t.jsxs)("div",{style:{fontSize:"0.65rem",color:"var(--text-muted)",fontFamily:"JetBrains Mono, monospace",marginBottom:"10px"},children:[(0,t.jsxs)("div",{children:["Autor: ",e.authorDid?.slice(0,16),"..."]}),(0,t.jsxs)("div",{children:["Recibido: ",new Date(e.timestamp).toLocaleTimeString()]})]})]}),(0,t.jsxs)("div",{style:{display:"flex",gap:"8px",paddingTop:"10px",borderTop:"1px solid rgba(255, 255, 255, 0.08)"},children:[e.pkg&&(0,t.jsx)("button",{type:"button",onClick:()=>K(e.pkg,"Paquete Malla"),style:{padding:"6px 10px",background:"rgba(255, 255, 255, 0.06)",border:"1px solid rgba(255, 255, 255, 0.12)",color:"#FFFFFF",borderRadius:"8px",fontSize:"0.72rem",cursor:"pointer"},title:"Copiar paquete firmado base64",children:"📋 Copiar"}),(0,t.jsx)("button",{type:"button",onClick:()=>(e=>{if(d.TacticalAudioEngine.playTap(),e.pkg){let t=i.redAppRegistry.importAppPackage(e.pkg);if(t.isValid&&t.bundle){i.redAppRegistry.installApp(t.bundle),q(),d.TacticalAudioEngine.playMessageSent(),l.toast.success(`🚀 Mini-App '${t.bundle.manifest.name}' instalada desde la malla.`),m(t.bundle);return}}d.TacticalAudioEngine.playWarning(),l.toast.error("El paquete recibido no contiene un bundle ejecutable válido.")})(e),style:{flex:1,padding:"6px 12px",background:"linear-gradient(135deg, #00E676 0%, #00E5FF 100%)",border:"none",color:"#000000",fontWeight:900,borderRadius:"8px",fontSize:"0.75rem",cursor:"pointer"},children:"⚡ Instalar e Iniciar"})]})]},e.appId))})]})]})})}])},18893,e=>{e.n(e.i(35286))}]);