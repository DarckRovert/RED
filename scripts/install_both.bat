...
if not exist "%APK%" set APK=d:\PROYECTO RED\release-assets\red-v96.0.0-release.apk
if not exist "%APK%" set APK=d:\PROYECTO RED\release-assets\red-latest.apk

echo === INSTALACION MULTI-DISPOSITIVO RED (RELEASE v96.0.0) ===
