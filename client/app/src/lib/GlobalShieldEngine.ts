...
import { MeshProofOfWork } from "./MeshProofOfWork";
import { SniSpoofEngine } from "./sniSpoofEngine";
import { DnsTunnelEngine } from "./dnsTunnelEngine";
import { KineticDutyGovernor } from "./KineticDutyGovernor";
import { BiometricLockEngine } from "./BiometricLockEngine";
...
export class GlobalShieldEngine {
    ...
    private notifyListeners(): void {
        ...
        this.listeners.forEach(fn => {
            try { fn(telemetry); } catch (e) { console.error(e); }
        });
    }
}
