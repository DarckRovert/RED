...
export function useSquadCallMesh({
    ...
    // ── 2. SDP Bitrate Throttling — Tactical Voice (16 kbps Opus Mono) ────────
    /**
    ...
    // ── 3. DataChannel & WebRTC Connection Management ────────────────────────
    ...
    // ── 4. ICE Candidates & Close Peer Helpers ───────────────────────────────
    ...
    // ── 9. Setup Local Media Stream Effect ────────────────────────────────────
    useEffect(() => {
    ...
    // ── 10. Process Incoming Signaling FIFO Queue Effect ──────────────────────
    useEffect(() => {
