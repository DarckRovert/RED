...
const TACTICAL_SEARCHABLE_TOOLS: TacticalSearchResult[] = [
    ...
    { id: "cyberTunnel", icon: "⚡", label: "Túnel Zero-Rating & APN", desc: "Bypass de datos móviles por SNI y proxy satelital local", action: "cyberTunnel", keywords: ["apn", "vpn", "tunnel", "tunel", "datos", "proxy", "zero-rating", "zerorating", "gratis", "movistar", "claro", "entel", "bitel", "saldo", "internet"] },
    { id: "tacticalGhostGps", icon: "👻", label: "Ghost GPS & Señuelo Táctico", desc: "Spoofing táctico de coordenadas y evasión anti-rastreo", action: "tacticalGhostGps", keywords: ["ghost", "gps", "señuelo", "senuelo", "spoof", "spoofing", "ubicacion", "falsa", "antitracking", "evasion", "coordenadas"] },
    { id: "sovereignShield", icon: "🛡️", label: "Sovereign Shield C4ISR", desc: "Defensa celular, filtro de llamadas spam y auditoría de apps", action: "sovereignShield", keywords: ["shield", "escudo", "llamadas", "spam", "antispam", "bloqueo", "defensa", "permisos", "apps", "soberano", "seguridad"] },
    { id: "extremeSurvival", icon: "⚡", label: "Supervivencia Extrema (Blackout)", desc: "Consola de choque de alto estrés: SOS urgente, linterna estroboscópica y sirena", action: "extremeSurvival", keywords: ["supervivencia", "extrema", "blackout", "sos", "sirena", "linterna", "estres", "panico"] },
    { id: "ecoMesh", icon: "🔋", label: "Gobernador EcoMesh", desc: "Ciclos de reposo cinético y modulación de potencia de batería", action: "ecoMesh", keywords: ["eco", "ecomesh", "bateria", "energia", "ahorro", "gobernador", "power"] },
    { id: "swarmHealthHUD", icon: "📶", label: "Salud del Enjambre & QoS", desc: "Supervisión en tiempo real de SNR, RSSI, pérdida de paquetes y portadores", action: "swarmHealthHUD", keywords: ["enjambre", "swarm", "salud", "qos", "snr", "rssi", "paquetes", "telemetria"] },
    { id: "secReport", icon: "📑", label: "Reporte Forense C4ISR", desc: "Diagnóstico criptográfico formal y cumplimiento de estándares de privacidad", action: "secReport", keywords: ["reporte", "forense", "c4isr", "auditoria", "cumplimiento", "norma", "seguridad"] },
    { id: "backup", icon: "💾", label: "Respaldo & Recuperación BIP-39", desc: "Exportación e importación blindada de la bóveda mediante frase semilla", action: "backup", keywords: ["respaldo", "backup", "recuperacion", "semilla", "bip39", "restaurar", "boveda"] },
