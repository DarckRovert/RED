    ...
    return (
        <div id="nearby-devices-panel" style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
                <div style={{
                    width: '40px', height: '40px', background: 'rgba(232,0,28,0.12)',
                    border: '1px solid rgba(232,0,28,0.25)', borderRadius: '12px',
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    ...
                    <button
                        ...
                        style={{
                            ...
                            background: scanning ? 'rgba(232,0,28,0.15)' : 'rgba(255,255,255,0.04)',
                            color: scanning ? '#ff2d47' : '#a0a0b8',
                            fontWeight: 600,
                            fontSize: '0.85rem',
