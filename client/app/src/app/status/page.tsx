    ...
    return (
        <main className="status-page bg-dark">
            ...
            <section className="status-contacts-section">
                ...
                <div className="empty-state-full animate-fade" style={{ padding: '3rem 1rem', marginTop: '1rem', background: 'var(--surface-2)', borderRadius: '12px' }}>
                    <div className="status-avatar-placeholder" style={{ width: '60px', height: '60px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1rem', background: 'var(--surface)', border: '1px solid var(--glass-border)' }}>
                        <span style={{ fontSize: "1.5rem" }}>🌀</span>
                    </div>
                    <h3 style={{ fontSize: '1.1rem', marginBottom: '0.4rem', color: 'var(--text-primary)' }}>Sin estados nuevos</h3>
                    <p style={{ textAlign: 'center', color: 'var(--text-muted)', fontSize: '0.85rem', maxWidth: '80%' }}>
                        Los estados encriptados o efímeros de tus contactos 24h aparecerán aquí.
                    </p>
                </div>
            </section>
