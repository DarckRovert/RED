...
const SHARED_MEDIA_MOCK: MediaItem[] = [
    { type: "image", url: "https://picsum.photos/seed/red1/200/200", caption: "Captura de pantalla 1" },
    { type: "image", url: "https://picsum.photos/seed/red2/200/200", caption: "Foto enviada" },
    { type: "image", url: "https://picsum.photos/seed/red3/200/200", caption: "Logo RED" },
    { type: "file", name: "whitepaper_RED.pdf", size: "1.2 MB", icon: "📄" },
    { type: "file", name: "claves_backup.txt", size: "4 KB", icon: "🔐" },
];
...
function ContactProfileContent() {
    ...
    const contact = (contactId ? contacts.find(c => c.id === contactId) : null)
        ?? contacts[0]
        ?? { id: "demo", displayName: "Satoshi Nakamoto", identity_hash: "abc123def456abc123def456" };
    ...
    return (
        <main className="contact-profile-page bg-dark">
            ...
            <div className="contact-profile-hero">
                <Link href="/chat" className="back-btn profile-back">←</Link>
