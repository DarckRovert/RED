...
// In production this would come from the RED store (useRedStore)
const MOCK_LOCAL_ID = typeof window !== 'undefined'
    ? (localStorage.getItem('red_local_id') ?? 'local-unknown')
    : 'local-unknown';
